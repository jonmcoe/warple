...
this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Color Blind Mode</div>\n          <div class="description">High contrast colors</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback (Wordle)</div>\n        </div>\n        <div class="control">\n          <a href="mailto:wordle@powerlanguage.co.uk?subject=Wordle is great. Thank you!" title="wordle@powerlanguage.co.uk">Email</a>\n          |\n          <a href="https://twitter.com/intent/tweet?screen_name=powerlanguish" target="blank" title="@powerlanguish">Twitter</a>\n        </div>\n      </div>\n    </section><section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback (Warple)</div>\n        </div>\n        <div class="control">\n          <a href="https://www.github.com/jonmcoe/warple" title="https://www.github.com/jonmcoe/warple">Github</a>\n          \n          \n        </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div id="copyright">Copyright 2022. No Rights Reserved.</div>\n    <div>\n      <div id="puzzle-number"></div>\n      <div id="hash"></div>\n    </div>\n  </div>\n';
    var _a = function(e) {
        r(t, e);
        var a = h(t);
            ...
            return o(t, [{
                ...
                value: function () {
                    var e = this.$game.querySelector("game-modal"),
                        a = document.createElement("game-history");
                    a.gameApp = this;
                    e.appendChild(a);
                    e.setAttribute("open", "");
                },
    ...
    var historyTemplate = document.createElement("template");
    historyTemplate.innerHTML = `
        <style>
            ...
            .history-entry .actions .copy-history {
            }
    ...
    var historyEntry = document.createElement("template");
    ...
    const historyModal = (function (e) {
        r(t, e);
        var a = h(t);
        function t() {
            var e;
            return s(this, t), n(p((e = a.call(this))), "history", {}), n(p(e), "gameApp", void 0), e.attachShadow({ mode: "open" }), e;
        }
        return (
            o(t, [
                {
                    ...
                    value: function () {
                        const e = this;
                        this.shadowRoot.appendChild(historyTemplate.content.cloneNode(!0));
                        const recordList = this.shadowRoot.getElementById("history");
    ...
    customElements.define("game-history", historyModal);
    ...
    var Bs = {
            ...
            history: "M12 3C8 3 4 7 4 12 L 1 12 L 4.89 15.89 L 4.96 16 L 9 12 L 6 12 C 6 8.14 9.14 5 13 5 C 16.86 5 20 8.14 20 12 C 20 15.86 16.86 19 13 19 C 11 19 9.32 18.21 8.05 16.95 L 6.64 18.359375 C 8.265625 19.988281 10.511719 21 12.996094 21 C 17.97 21 22 16.97 22 12 C 22 7.03 17.97 3 13 3 Z M 12 8 L 12 13 L 16.28 15.54 L 17 14.32 L 13.5 12.25 L 13.5 8 Z M 12 8",
        },
        Fs = function(e) {
            r(t, e);
            var a = h(t);
