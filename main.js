                    ...
                    return (
                        ...
                        !e.lastPlayedTs || Na(new Date(e.lastPlayedTs), e.today) >= 1
                            ? ((e.boardState = new Array(6).fill("")),
                              ...
                              Ca("event", "level_start", { level_name: Wa(e.solution), level_number: activeRound }))
                                ...
                                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                                    ...
                                    if (i || l)
                                        Va({ isWin: l, isStreak: !!this.lastCompletedTs && 1 === Na(new Date(this.lastCompletedTs), new Date()), numGuesses: this.rowIndex }),
                                            ...
                                            Ca("event", "level_end", { level_name: Wa(this.solution), num_guesses: this.rowIndex, success: l, level_number: activeRound });
                                    (this.tileIndex = 0),
                                        (this.canInput = !1),
